...
from main.core.test_framework.plans.selector_helpers import get_spread_selectors
#
# ---------------------------------------------------------------------
# 1. Generic runner
# ---------------------------------------------------------------------
...
#     sizes = get_spread_selectors(schema, "mysql") if spread else get_size_based_selectors(schema, "mysql")
#
#     default_steps = (
...
def _generic_extreme_suite(*, users: list[int], run_time: int, tag: str,
    ...
    ## i want you to print all the sizes t1..t7:
    print("Sizes:", sizes)
